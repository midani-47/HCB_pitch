...
.steps::before{content:'';position:absolute;top:clamp(44px,5vw,54px);left:calc(10% + 13px);right:calc(10% + 13px);height:1px;background:linear-gradient(90deg,var(--teal),var(--purple));opacity:.22;z-index:0}
.step{display:flex;flex-direction:column;align-items:center;text-align:center;padding:0 10px;position:relative;z-index:1}
.step-num{width:clamp(88px,10vw,108px);height:clamp(88px,10vw,108px);border-radius:50%;background:linear-gradient(135deg,rgba(61,219,166,.18),rgba(124,99,245,.18));border:1px solid rgba(61,219,166,.32);display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:18px;flex-shrink:0;overflow:hidden}
.step-num img{width:clamp(44px,5.6vw,60px);height:clamp(44px,5.6vw,60px);object-fit:contain;display:block}
...
<div class="sec" id="process">
  ...
  <div class="steps reveal">
    ...
    <div class="step">
      <div class="step-num">
        <img src="assets/images/mail-icon-clipart-original.png" alt="">
      </div>
    ...
    <div class="step">
      <div class="step-num">
        <img src="assets/images/science-lab-computer-displaying-molecule-structure-tmxUxJvF.png" alt="">
      </div>
    ...
    <div class="step">
      <div class="step-num">
        <img src="assets/images/portable-network-graphics-business-analysis-market-research-clip-art-png-favpng-rryvCud5FfgJpMbKKF28XHw0Y.png" alt="">
      </div>
